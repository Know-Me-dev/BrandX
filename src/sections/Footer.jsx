      ...
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 text-white-400 font-montserrat sm:max-w-sm"> 
            Get shoes ready for new term at your nearest Nike store. Find your perfect Size in Store. Get Rewards
          </p>
            ...
            <div key={index}>
              ...
              <ul>
                {section.links.map((link, idx) => (
                  <li 
                    className=" mt-3 text-white-400 font-montserrat text-base cursor-pointer hover:text-slate-gray"
                    key={idx}
                  >
